...
public class IMMiningDialog extends JPanel {
	...
	private final JLabel minFieldLable;
	private final JLabel maxFieldLable;
	private final JLabel stepSizeLable;
	public final JTextField minFieldValue;
	public final JTextField maxFieldValue;
	public final JTextField stepSizeValue;
	...
	public abstract class Variant {
		...
		public boolean isFScore() {
			return false;
		}
	}

	// Custome Classs
	public class VariantFScore extends Variant{
		public String toString() {
			return "Inductive Miner - Compute F-Score";
		}
	...
	private static String createInteger(String limitType) {
		return JOptionPane.showInputDialog(null, "Provide an Integer Value for " + limitType + "." ,
				"Limit Decider", JOptionPane.QUESTION_MESSAGE);
	}
	...
	public IMMiningDialog(XLog log) {
		...
		variantCombobox = factory.createComboBox(new Variant[] { new VariantIMf()
				//,new VariantIM(), new VariantFScore(), new VariantIMa(),
		...
		minFieldLable = factory.createLabel("MinLimit");
		{
						
			GridBagConstraints cMinLabel = new GridBagConstraints();
			cMinLabel.gridx = 0;
			cMinLabel.gridy = gridy;
			cMinLabel.weightx = 0.4;
			cMinLabel.anchor = GridBagConstraints.NORTHWEST;
			add(minFieldLable, cMinLabel);
		}
		

//		String num = createInteger("min limit");
//		while(!isInteger(num)) {
//			JOptionPane.showMessageDialog(null, "Make sure you have entered The correct Type Integer", "Number Error", JOptionPane.ERROR_MESSAGE);
//			num = createInteger("min limit");
//		}
		minFieldValue = new JTextField(" ", 5);
		minFieldValue.setText("0.1");
		{
			GridBagConstraints cMinValue = new GridBagConstraints();
			cMinValue.gridx = 1;
			cMinValue.gridy = gridy;
			cMinValue.anchor = GridBagConstraints.NORTHWEST;
			cMinValue.weightx = 0.6;
			add(minFieldValue, cMinValue);
		}
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//SetLimit
		 maxFieldLable = factory.createLabel("MaxLimit");
		{
			GridBagConstraints cmaxLimit = new GridBagConstraints();
			cmaxLimit.gridx = 0;
			cmaxLimit.gridy = gridy;
			cmaxLimit.weightx = 0.4;
			cmaxLimit.anchor = GridBagConstraints.NORTHWEST;
			add(maxFieldLable, cmaxLimit);
		}
		

//		String maxNum = createInteger("max limit");
//		
//		while(!isInteger(maxNum) && Integer.parseInt(minLimit.getText())<Integer.parseInt(maxNum)) {
//			JOptionPane.showMessageDialog(null, "Make sure you have entered The correct Type Integer and its greater thean Min Limit", "Number Error", JOptionPane.ERROR_MESSAGE);
//			num = createInteger("Max limit");
//		}
		maxFieldValue = new JTextField(" ", 5);
		maxFieldValue.setText("0.5");
		{
			
			GridBagConstraints cMaxValue = new GridBagConstraints();
			cMaxValue.gridx = 1;
			cMaxValue.gridy = gridy;
			cMaxValue.anchor = GridBagConstraints.NORTHWEST;
			cMaxValue.weightx = 0.6;
			add(maxFieldValue, cMaxValue);
		}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//SetLimit
		stepSizeLable = factory.createLabel("StepSize");
		
		
		{	
			GridBagConstraints cstepSizeValue = new GridBagConstraints();
			cstepSizeValue.gridx = 0;
			cstepSizeValue.gridy = gridy;
			cstepSizeValue.weightx = 0.4;
			cstepSizeValue.anchor = GridBagConstraints.NORTHWEST;
			add(stepSizeLable, cstepSizeValue);
		}
		
		stepSizeValue = new JTextField(" ", 5);
		stepSizeValue.setText("0.1");
		{
			GridBagConstraints cstepSizeValue = new GridBagConstraints();
			cstepSizeValue.gridx = 1;
			cstepSizeValue.gridy = gridy;
			cstepSizeValue.anchor = GridBagConstraints.NORTHWEST;
			cstepSizeValue.weightx = 0.6;
			add(stepSizeValue, cstepSizeValue);
		}
		
		...
		variantCombobox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (variant.hasNoise()) {
					...
					minFieldLable.setVisible(variant.isFScore());
					minFieldValue.setVisible(variant.isFScore());
					
					maxFieldLable.setVisible(variant.isFScore());
					maxFieldValue.setVisible(variant.isFScore());
					
					stepSizeLable.setVisible(variant.isFScore());
					stepSizeValue.setVisible(variant.isFScore());									
