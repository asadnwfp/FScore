...
//		return null;
		...
		return checkMultiETCAlign1(context,log,net,sett);
	}
	...
	// Custom Method with ResultConfiguration
	public Object[] checkMultiETCAlign1(UIPluginContext context, XLog log, Petrinet net, MultiETCSettings sett,Object[] resultConfiguration) throws ConnectionCannotBeObtained {
		// Compute the 1-Alignments
		//Get Params
		if (resultConfiguration == null) {
			context.getFutureResult(0).cancel(true);
