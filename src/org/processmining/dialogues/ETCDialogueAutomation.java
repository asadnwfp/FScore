...
public class ETCDialogueAutomation extends JPanel {
...
//		else if(this.rdbtnMultiset.isSelected()) sett.put(MultiETCSettings.REPRESENTATION, MultiETCSettings.Representation.UNORDERED);
		...
		//Get the Algorithm
//		if( algList.getSelectedValue() == ETCDialogueAutomation.ETC) sett.put(MultiETCSettings.ALGORITHM, MultiETCSettings.Algorithm.ETC);
//		else if( algList.getSelectedValue() == ETCDialogueAutomation.ALIGN_1) sett.put(MultiETCSettings.ALGORITHM, MultiETCSettings.Algorithm.ALIGN_1);
//		else if( algList.getSelectedValue() == ETCDialogueAutomation.ALIGN_REPRE) sett.put(MultiETCSettings.ALGORITHM, MultiETCSettings.Algorithm.ALIGN_REPRE);
//		else if( algList.getSelectedValue() == ETCDialogueAutomation.ALIGN_ALL) sett.put(MultiETCSettings.ALGORITHM, MultiETCSettings.Algorithm.ALIGN_ALL);
