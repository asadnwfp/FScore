 ...
 * 
 */
public class PNReplyerUIAutomation {
	...
	// private Reference
	private EvClassLogPetrinetConnection conn ;
	private XEventClass xEventClass;
	private XEventClassifier xEventClassifier;

	// Get Refrence
	public EvClassLogPetrinetConnection getConn() {
		return conn;
	}
	...
	public void setxEventClassifier(XEventClassifier xEventClassifier) {
	...
	public Object[] getConfiguration(UIPluginContext context, PetrinetGraph net, XLog log) {
		...
		// Setting Mapping calssifier and dummy class for use in LogReplyer
